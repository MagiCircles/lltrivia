...
Elm.Sukutomo = Elm.Sukutomo || {};
Elm.Sukutomo.make = function (_elm) {
   "use strict";
   _elm.Sukutomo = _elm.Sukutomo || {};
   if (_elm.Sukutomo.values) return _elm.Sukutomo.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Question.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Sukutomo = Elm.Sukutomo.make(_elm);
   var _op = {};
   var questionToHtml = F2(function (question,btnColor) {
      var s = function () {
         var _p0 = question.question;
         switch (_p0.ctor)
         {case "IdolHobby": return $Html.text(A2($Basics._op["++"],
              "Who likes ",
              A2($Basics._op["++"],$String.toLower(_p0._0),"?")));
            case "IdolFood": return $Html.text(A2($Basics._op["++"],
              "Who likes ",
              A2($Basics._op["++"],$String.toLower(_p0._0),"?")));
            case "IdolLeastFood": return $Html.text(A2($Basics._op["++"],
              "Who dislikes ",
              A2($Basics._op["++"],$String.toLower(_p0._0),"?")));
            case "CardAttribute": return A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Html$Attributes.$class("question-with-image")]),
                      _U.list([$Html.text("What is the attribute of this card?")]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-5")]),
                      _U.list([A2($Html.img,
                      _U.list([$Html$Attributes.$class("image-with-question")
                              ,$Html$Attributes.src(_p0._0)]),
                      _U.list([]))]))]));
            case "CardRarity": return A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-7")]),
                      _U.list([A2($Html.span,
                      _U.list([$Html$Attributes.$class("question-with-image")]),
                      _U.list([$Html.text("What is the rarity of this card?")]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-5")]),
                      _U.list([A2($Html.img,
                      _U.list([$Html$Attributes.$class("image-with-question")
            ...
            default: return A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.span,
                      _U.list([$Html$Attributes.$class("question-with-image")]),
                      _U.list([$Html.text("Who is the idol in this card?")]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-5")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("image-question-detail")
            ...
            {case "IdolFood": var _p3 = _p9;
               ...
               case "IdolLeastFood": var _p4 = _p9;
                 if (_p4.ctor === "IdolAnswer") {
                       return _U.eq(_p2._1.least_favorite_food,
                       _p4._0.least_favorite_food);
                    } else {
                       return false;
                    }
   ...
   var answerQuestion = F2(function (answer,question) {
      return {question: question.question
             ,answer: $Maybe.Just(answer)};
   });
   var newQuestion = function (question) {
      return {question: question,answer: $Maybe.Nothing};
   };
   var StringAnswer = function (a) {
      return {ctor: "StringAnswer",_0: a};
   };
   var IdolAnswer = function (a) {
      return {ctor: "IdolAnswer",_0: a};
   };
   var CardDetail = F3(function (a,b,c) {
      return {ctor: "CardDetail",_0: a,_1: b,_2: c};
   });
   var CardRarity = F2(function (a,b) {
      return {ctor: "CardRarity",_0: a,_1: b};
   });
   var CardAttribute = F2(function (a,b) {
      return {ctor: "CardAttribute",_0: a,_1: b};
   });
   var IdolHobby = F3(function (a,b,c) {
      return {ctor: "IdolHobby",_0: a,_1: b,_2: c};
   });
   var IdolLeastFood = F3(function (a,b,c) {
      return {ctor: "IdolLeastFood",_0: a,_1: b,_2: c};
   });
   var IdolFood = F3(function (a,b,c) {
      return {ctor: "IdolFood",_0: a,_1: b,_2: c};
   });
   var Question = F2(function (a,b) {
      return {question: a,answer: b};
   });
   var ChangeQuizz = function (a) {
      return {ctor: "ChangeQuizz",_0: a};
   };
   ...
   var stringOptions = F3(function (address,question,strings) {
      var format = function (str) {
         ...
         _U.list([$Html$Attributes.href("#")
                 ...
                 address,
                 Answer(A2(answerQuestion,StringAnswer(str),question)))]),
   ...
   var imageOptions = F3(function (address,question,images) {
      var format = function (_p10) {
         ...
         _U.list([$Html$Attributes.href("#")
                 ,A2($Html$Events.onClick,
                 address,
                 Answer(A2(answerQuestion,StringAnswer(_p12),question)))]),
         _U.list([A2($Html.img,
         _U.list([$Html$Attributes.src(_p11._0)
                 ,$Html$Attributes.alt(_p12)
                 ,$Html$Attributes.$class("choice-image")]),
         _U.list([]))]));
      };
      return A2($List.map,format,images);
   });
   var idolOptions = F3(function (address,question,idols) {
      var format = function (element) {
         return A2($Html.figure,
         _U.list([$Html$Attributes.$class("trivia_idol")]),
         _U.list([A2($Html.img,
                 _U.list([$Html$Attributes.src(element.chibi)
                         ,A2($Html$Events.onClick,
                         address,
                         Answer(A2(answerQuestion,IdolAnswer(element),question)))]),
      ...
      var aux = F2(function (acc,l) {
         aux: while (true) {
            ...
            if (_p13.ctor === "[]") {
                  ...
                  var _v11 = A2($List._op["::"],format(_p13._0),acc),
                  _v12 = _p13._1;
                  acc = _v11;
                  l = _v12;
                  continue aux;
   ...
   var optionsToHtml = F2(function (address,question) {
      ...
      switch (_p14.ctor)
      {case "IdolHobby": return A3(idolOptions,
           address,
           question,
           _p14._2);
         case "IdolFood": return A3(idolOptions,
           address,
           question,
           _p14._2);
         case "IdolLeastFood": return A3(idolOptions,
           address,
           question,
           _p14._2);
         case "CardRarity": return A3(imageOptions,
           ...
           _U.list([{ctor: "_Tuple2"
                    ,_0: A2($Basics._op["++"],
                    "http://i.schoolido.lu/static/N",
                    A2($Basics._op["++"],btnColor,".png"))
                    ,_1: "N"}
                   ,{ctor: "_Tuple2"
                    ,_0: A2($Basics._op["++"],
                    "http://i.schoolido.lu/static/R",
                    A2($Basics._op["++"],btnColor,".png"))
                    ,_1: "R"}
                   ,{ctor: "_Tuple2"
                    ,_0: A2($Basics._op["++"],
                    "http://i.schoolido.lu/static/SR",
                    A2($Basics._op["++"],btnColor,".png"))
                    ,_1: "SR"}
                   ,{ctor: "_Tuple2"
                    ,_0: A2($Basics._op["++"],
                    "http://i.schoolido.lu/static/UR",
                    A2($Basics._op["++"],btnColor,".png"))
                    ,_1: "UR"}]));
         case "CardAttribute": return A3(imageOptions,
           address,
           question,
           _U.list([{ctor: "_Tuple2"
                    ,_0: "http://i.schoolido.lu/static/Smile.png"
                    ,_1: "Smile"}
                   ,{ctor: "_Tuple2"
                    ,_0: "http://i.schoolido.lu/static/Pure.png"
                    ,_1: "Pure"}
                   ,{ctor: "_Tuple2"
                    ,_0: "http://i.schoolido.lu/static/Cool.png"
                    ,_1: "Cool"}
                   ,{ctor: "_Tuple2"
                    ,_0: "http://i.schoolido.lu/static/All.png"
                    ,_1: "All"}]));
...
Elm.Main.make = function (_elm) {
   ...
   var formatComment = function (score) {
      return _U.cmp(score,0) < 1 ? "Ouch!" : _U.cmp(score,
      3) < 1 ? "Oh no..." : _U.cmp(score,
      5) < 1 ? "Meh." : _U.cmp(score,
      7) < 1 ? "Not bad!" : _U.cmp(score,
   ...
   var formatQuizzButtons = F2(function (addr,quizz) {
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("nav nav-tabs")]),
      _U.list([A2($Html.li,
              _U.list([$Html$Attributes.$class("active")]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("#all")
                      ,A2($Html$Events.onClick,
                      addr,
                      $Question.ChangeQuizz($Question.All))]),
              _U.list([A2($Html.i,
                      _U.list([$Html$Attributes.$class("flaticon-album")]),
                      _U.list([]))
                      ,$Html.text(" All")]))]))
              ,A2($Html.li,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("#cards")
                      ,A2($Html$Events.onClick,
                      addr,
                      $Question.ChangeQuizz($Question.Cards))]),
              _U.list([A2($Html.i,
                      _U.list([$Html$Attributes.$class("flaticon-cards")]),
                      _U.list([]))
                      ,$Html.text(" Cards")]))]))
              ,A2($Html.li,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("#idols")
                      ,A2($Html$Events.onClick,
                      addr,
                      $Question.ChangeQuizz($Question.Idols))]),
              _U.list([A2($Html.i,
                      _U.list([$Html$Attributes.$class("flaticon-idolized")]),
                      _U.list([]))
                      ,$Html.text(" Idols")]))]))]));
   });
   var resultView = F2(function (addr,model) {
      var quizzbuttons = A2(formatQuizzButtons,addr,model.quizz);
      var score = A3($List.foldl,
      F2(function (answer,s) {    return answer ? s + 1 : s;}),
      0,
      model.score);
      ...
      _U.list([quizzbuttons
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.h3,
                              _U.list([]),
                              _U.list([$Html.text("Final Score")]))
                              ,A2($Html.span,
                              _U.list([$Html$Attributes.$class("final_score")]),
                              _U.list([$Html.text($Basics.toString(score))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-6")]),
                      _U.list([A2($Html.p,
                              _U.list([$Html$Attributes.$class("score_comment")]),
                              _U.list([$Html.text(comment)]))
                              ,A2($Html.p,
                              ...
                              _U.list([A2($Html.a,
                                      ...
                                      _U.list([A2($Html.img,
                                              _U.list([$Html$Attributes.src("/static/twitter.png")]),
                                              _U.list([]))
                                      ...
                                      _U.list([$Html$Attributes.method("POST")
                                              ,$Html$Attributes.action("/ajax/trivia/share/")]),
                                      ...
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.a,
                                      _U.list([A2($Html$Events.onClick,addr,$Question.Restart)
   ...
   var mapMaybe = function (l) {
      var aux = F2(function (l,acc) {
         aux: while (true) {
            var _p0 = l;
            if (_p0.ctor === "::") {
                  if (_p0._0.ctor === "_Tuple2" && _p0._0._0.ctor === "Just" && _p0._0._1.ctor === "Just")
                  {
                        var _v1 = _p0._1,
                        _v2 = A2($List._op["::"],
                        {ctor: "_Tuple2",_0: _p0._0._0._0,_1: _p0._0._1._0},
                        acc);
                        l = _v1;
                        acc = _v2;
                        continue aux;
                     } else {
                        var _v3 = _p0._1,_v4 = acc;
                        l = _v3;
                        acc = _v4;
                        continue aux;
                     }
   ...
   var mapQuestion = F3(function (ctor,element,l) {
      ...
      if (_p1.ctor === "Nothing") {
            ...
            return A2($List._op["::"],ctor(_p1._0),l);
         }
   });
   _op["**"] = F2(function (func,value) {
   ...
   var cardsDecoder = function () {
      ...
      A2($Json$Decode._op[":="],"name",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"japanese_name",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"rarity",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"attribute",$Json$Decode.string)),
      $Json$Decode.maybe(A2($Json$Decode._op[":="],
      "card_image",
      $Json$Decode.string))),
   ...
   var End = {ctor: "End"};
   var Pending = function (a) {
      return {ctor: "Pending",_0: a};
   };
   var api_url = "http://schoolido.lu/api/";
   var idols_url = A2($Basics._op["++"],
   api_url,
   "idols/?ordering=random&cards__is_special=False&page_size=100");
   var getIdols = function (_p2) {
   ...
   var randomChoices = F4(function (idol,num,idols,seed) {
      var aux = F4(function (arr,n,acc,seed) {
         aux: while (true) if (_U.eq(n,0)) return {ctor: "_Tuple2"
                                                  ,_0: acc
                                                  ,_1: seed}; else {
               var _p5 = A2($Random$Array.choose,seed,arr);
               var choosen = _p5._0;
               var seed$ = _p5._1;
               var rest = _p5._2;
               var _p6 = choosen;
      ...
      return A4(aux,idols,num,_U.list([idol]),seed);
   });
   var getIdolAndOptions = F3(function (seed,name,idols) {
      var aux = F3(function (idols,acc,idol) {
         aux: while (true) {
            ...
            if (_p7.ctor === "[]") {
                  ...
                  var _p9 = _p7._1;
                  var _p8 = _p7._0;
                  if (_U.eq(_p8.name,name)) {
                        var _v12 = _p9,_v13 = acc,_v14 = $Maybe.Just(_p8);
                        idols = _v12;
                        acc = _v13;
                        idol = _v14;
                        continue aux;
      ...
      if (_p10._0.ctor === "Just") {
            ...
            var seed$$ = _p12._1;
            return {ctor: "_Tuple2"
                   ,_0: $Maybe.Just({ctor: "_Tuple2",_0: _p13,_1: shuffled})
                   ,_1: seed$$};
         } else {
   ...
   var pickCardQuestion = F3(function (card,seed,idols) {
      var _p14 = A2($Random$Array.sample,
      seed,
      $Array.fromList(mapMaybe(_U.list([{ctor: "_Tuple2"
                                        ,_0: card.card_image
                                        ,_1: card.transparent_image}
                                       ,{ctor: "_Tuple2"
                                        ,_0: card.card_idolized_image
                                        ,_1: card.transparent_idolized_image}]))));
      var images = _p14._0;
      var seed$ = _p14._1;
      var _p15 = images;
      if (_p15.ctor === "Just") {
            var _p18 = _p15._0._1;
            var _p16 = A3(getIdolAndOptions,seed$,card.name,idols);
            if (_p16._0.ctor === "Just") {
                  var questions = _U.list([A2($Question.CardAttribute,
                                          _p18,
                                          card)
                                          ,A2($Question.CardRarity,_p18,card)
                                          ,A3($Question.CardDetail,
                                          _p15._0._0,
                                          _p16._0._0._0,
                                          _p16._0._0._1)]);
                  var _p17 = A2($Random$Array.sample,
                  _p16._1,
                  $Array.fromList(questions));
                  if (_p17._0.ctor === "Just") {
                        return {ctor: "_Tuple2"
                               ,_0: Pending($Question.newQuestion(_p17._0._0))
                               ,_1: _p17._1};
                     } else {
                        return {ctor: "_Tuple2"
                               ,_0: Debug("Error while picking question")
                               ,_1: _p17._1};
                     }
               } else {
                  return {ctor: "_Tuple2"
                         ,_0: Debug("Error while finding the correct idol")
                         ,_1: _p16._1};
               }
         } else {
            return {ctor: "_Tuple2"
                   ,_0: Debug("Error while picking idol type")
                   ,_1: seed$};
         }
   });
   var pickIdolQuestion = F2(function (idols,seed) {
      var _p19 = A2($Random$Array.choose,
      seed,
      $Array.fromList(idols));
      if (_p19._0.ctor === "Just") {
            ...
            _p23.hobbies,
            A3(mapQuestion,
            $Question.IdolLeastFood,
            _p23.least_favorite_food,
            A3(mapQuestion,
            $Question.IdolFood,
            _p23.favorite_food,
            _U.list([]))));
            var _p20 = A2($Random$Array.choose,
            _p19._1,
            $Array.fromList(questions));
            if (_p20._0.ctor === "Just") {
                  var _p21 = A4(randomChoices,_p23,5,_p19._2,_p20._1);
                  var choices = _p21._0;
                  var seed$$$ = _p21._1;
                  ...
                  var seed$$$$ = _p22._1;
                  return {ctor: "_Tuple2"
                         ,_0: Pending($Question.newQuestion(A2(_p20._0._0,
                         _p23,
                         shuffled)))
                         ,_1: seed$$$$};
               } else {
                  return {ctor: "_Tuple2"
                         ,_0: Debug("Error while choosing a question")
                         ,_1: seed};
               }
         } else {
            return {ctor: "_Tuple2"
                   ,_0: Debug("Error while picking an idol for this question")
                   ,_1: seed};
         }
   });
   var pickQuestion = F2(function (quizz,model) {
      pickQuestion: while (true) {
         ...
         if (_p24.ctor === "Nothing") {
               ...
               var _p25 = quizz;
               switch (_p25.ctor)
               {case "Idols": var _p26 = A2(pickIdolQuestion,_p31,model.seed);
                    var state = _p26._0;
                    var seed = _p26._1;
                  ...
                  default: var choices = $Array.fromList(_U.list([$Question.Cards
                                                                 ,$Question.Idols]));
                    var _p29 = A2($Random$Array.sample,model.seed,choices);
                    var choice = _p29._0;
                    var seed = _p29._1;
                    var model = _U.update(model,{seed: seed});
                    var _p30 = choice;
                    if (_p30.ctor === "Just") {
                          var _v28 = _p30._0,_v29 = model;
                          quizz = _v28;
                          model = _v29;
                          ...
                          return {ctor: "_Tuple2"
                                 ,_0: _U.update(model,
                                 {state: Debug("Error while picking quizz")})
                                 ,_1: $Effects.none};
                       }}
            }
      }
   ...
   var update = F2(function (action,model) {
      var _p32 = action;
      switch (_p32.ctor)
      {case "Restart": var model = _U.update(model,
           {score: _U.list([])});
           return A2(pickQuestion,model.quizz,model);
         case "ChangeQuizz": var model = _U.update(model,
           {score: _U.list([]),quizz: _p32._0});
           return A2(pickQuestion,model.quizz,model);
         case "Answer": var score = $Question.checkAnswer(_p32._0);
           var model = _U.update(model,
           {score: A2($List._op["::"],score,model.score)});
           if (!_U.eq($List.length(model.score),10))
           return A2(pickQuestion,model.quizz,model); else {
   ...
   var view = F2(function (address,model) {
      var str = function () {
         ...
         switch (_p33.ctor)
         {case "Debug": return $Html.text(_p33._0);
            case "End": return A2(resultView,address,model);
            case "Pending": var _p34 = _p33._0;
              var quizzbuttons = A2(formatQuizzButtons,address,model.quizz);
              var fquestion = A2($Question.questionToHtml,_p34,btnColor);
              var foptions = A2($Question.optionsToHtml,address,_p34);
              var fprogress = formatProgress(model.score);
              return A2($Html.div,
              _U.list([]),
              A2($Basics._op["++"],
              _U.list([quizzbuttons,fquestion]),
              A2($Basics._op["++"],foptions,_U.list([fprogress]))));
            default: return A2($Html.i,
              _U.list([$Html$Attributes.$class("flaticon-loading")]),
              _U.list([]));}
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("sit")]),
      _U.list([A2($Html.strong,_U.list([]),_U.list([str]))]));
   });
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,update: update
                             ,formatQuizzButtons: formatQuizzButtons
