...
Elm.Main.make = function (_elm) {
   ...
   var cardsDecoder = function () {
      ...
      A2(_op["**"],
      A2(_op["**"],
      A2($Json$Decode.map,$Sukutomo.Card,A2($Json$Decode._op[":="],"name",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"japanese_name",$Json$Decode.string)),
      ...
      var aux = F4(function (arr,n,acc,seed) {
         aux: while (true) if (_U.eq(n,0)) return {ctor: "_Tuple2",_0: acc,_1: seed}; else {
               ...
               if (_p9.ctor === "Nothing") {
                     ...
                     var _v10 = rest,_v11 = n - 1,_v12 = A2($List._op["::"],_p9._0,acc),_v13 = seed$;
                     arr = _v10;
                     n = _v11;
                     acc = _v12;
                     seed = _v13;
         ...
         aux: while (true) {
            ...
            if (_p10.ctor === "[]") {
                  ...
                  if (_U.eq(_p11.name,name)) {
                        var _v15 = _p12,_v16 = acc,_v17 = $Maybe.Just(_p11);
                        idols = _v15;
                        acc = _v16;
                        idol = _v17;
                        continue aux;
                     } else {
                        var _v18 = _p12,_v19 = A2($List._op["::"],_p11,acc),_v20 = idol;
                        idols = _v18;
                        acc = _v19;
                        idol = _v20;
                        continue aux;
   ...
   var pickQuestion = F2(function (quizz,model) {
      pickQuestion: while (true) {
         ...
         if (_p27.ctor === "Nothing") {
               ...
               var _p28 = quizz;
               switch (_p28.ctor)
               {case "Idols": var _p29 = A2(pickIdolQuestion,_p34,model.seed);
                    var state = _p29._0;
                    var seed = _p29._1;
                    var model = _U.update(model,{state: state,seed: seed});
                    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                  case "Cards": var _p30 = model.cards;
                    if (_p30.ctor === "Nothing") {
                          return {ctor: "_Tuple2",_0: _U.update(model,{state: Init}),_1: getRandomCards({ctor: "_Tuple0"})};
                       } else {
                          if (_p30._0.ctor === "[]") {
                                return {ctor: "_Tuple2",_0: _U.update(model,{state: Init}),_1: getRandomCards({ctor: "_Tuple0"})};
                             } else {
                                var _p31 = A3(pickCardQuestion,_p30._0._0,model.seed,_p34);
                                var state = _p31._0;
                                var seed = _p31._1;
                                var model = _U.update(model,{state: state,seed: seed,cards: $Maybe.Just(_p30._0._1)});
                                return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                             }
                       }
                  default: var choices = $Array.fromList(_U.list([$Question.Cards,$Question.Idols]));
                    var _p32 = A2($Random$Array.sample,model.seed,choices);
                    var choice = _p32._0;
                    var seed = _p32._1;
                    var model = _U.update(model,{seed: seed});
                    var _p33 = choice;
                    if (_p33.ctor === "Just") {
                          var _v31 = _p33._0,_v32 = model;
                          quizz = _v31;
                          model = _v32;
   ...
   var update = F2(function (action,model) {
      ...
      {case "Restart": var model = _U.update(model,{score: _U.list([])});
         ...
         case "ChangeQuizz": var model = _U.update(model,{score: _U.list([]),quizz: _p35._0});
           return A2(pickQuestion,model.quizz,model);
         case "Answer": var score = $Question.checkAnswer(_p35._0);
         ...
         case "GotIdols": var model = _U.update(model,{idols: _p35._0});
           return A2(pickQuestion,model.quizz,model);
         default: var model = _U.update(model,{cards: _p35._0});
           return A2(pickQuestion,model.quizz,model);}
   });
   var btnColor = Elm.Native.Port.make(_elm).inbound("btnColor",
   "String",
   ...
   var view = F2(function (address,model) {
      var str = function () {
         ...
         switch (_p36.ctor)
         {case "Debug": return $Html.text(_p36._0);
            case "End": return A2(resultView,address,model);
            case "Pending": var _p37 = _p36._0;
              var quizzbuttons = A2(formatQuizzButtons,address,model.quizz);
              var fquestion = A2($Question.questionToHtml,_p37,btnColor);
              var foptions = A2($Question.optionsToHtml,address,_p37);
              var fprogress = formatProgress(model.score);
