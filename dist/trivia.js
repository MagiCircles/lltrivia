...
Elm.Main.make = function (_elm) {
   ...
   var shuffleList = F2(function (idols,seed) {
      var _p3 = A2($Random$Array.shuffle,seed,$Array.fromList(idols));
      var shuffled = _p3._0;
      var seed = _p3._1;
   ...
   var randomChoices = F4(function (idol,num,idols,seed) {
      var aux = F4(function (arr,n,acc,seed) {
         aux: while (true) if (_U.eq(n,0)) return {ctor: "_Tuple2",_0: acc,_1: seed}; else {
               var _p4 = A2($Random$Array.choose,seed,arr);
               var choosen = _p4._0;
               var seed = _p4._1;
               var rest = _p4._2;
               var _p5 = choosen;
               if (_p5.ctor === "Nothing") {
                     ...
                     var _v5 = rest,_v6 = n - 1,_v7 = A2($List._op["::"],_p5._0,acc),_v8 = seed;
                     arr = _v5;
                     n = _v6;
                     acc = _v7;
                     seed = _v8;
   ...
   var pickQuestion = F2(function (idols,seed) {
      var _p6 = idols;
      if (_p6.ctor === "Just") {
            var _p7 = A2($Random$Array.choose,seed,$Array.fromList(_p6._0));
            if (_p7._0.ctor === "Just") {
                  var _p12 = _p7._1;
                  var _p11 = _p7._0._0;
                  ...
                  Hobby,
                  _p11.hobbies,
                  A3(mapQuestion,LeastFood,_p11.least_favorite_food,A3(mapQuestion,Food,_p11.favorite_food,_U.list([]))));
                  var _p8 = A2($Random$Array.choose,_p12,$Array.fromList(questions));
                  if (_p8._0.ctor === "Just") {
                        var _p9 = A4(randomChoices,_p11,5,_p7._2,_p8._1);
                        var choices = _p9._0;
                        var seed = _p9._1;
                        var _p10 = A2(shuffleList,choices,seed);
                        var shuffled = _p10._0;
                        var seed = _p10._1;
                        return {ctor: "_Tuple2",_0: A3(Pending,_p11,shuffled,_p8._0._0),_1: seed};
                     } else {
                        return {ctor: "_Tuple2",_0: Debug("Error while choosing a question"),_1: _p12};
                     }
               } else {
   ...
   var update = F2(function (action,model) {
      var _p13 = action;
      switch (_p13.ctor)
      {case "Restart": var _p14 = A2(pickQuestion,model.idols,model.seed);
           var question = _p14._0;
           var seed = _p14._1;
           return {ctor: "_Tuple2",_0: {question: question,seed: seed,score: _U.list([]),idols: model.idols},_1: $Effects.none};
         case "Answer": var _p15 = model.question;
           if (_p15.ctor === "Pending") {
                 var score = !_U.eq(_p15._0.name,_p13._1.name) ? false : true;
                 var _p16 = !_U.eq($List.length(model.score),9) ? A2(pickQuestion,model.idols,model.seed) : {ctor: "_Tuple2",_0: End,_1: model.seed};
                 var question = _p16._0;
                 var seed = _p16._1;
         ...
         default: var _p18 = _p13._0;
           var _p17 = A2(pickQuestion,_p18,model.seed);
           var question = _p17._0;
           var seed = _p17._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{question: question,seed: seed,idols: _p18}),_1: $Effects.none};}
   });
   var nth = F2(function (n,l) {
      nth: while (true) {
         ...
         if (_p19.ctor === "[]") {
               ...
               if (_U.cmp(n,0) < 1) return $Maybe.Just(_p19._0); else {
                     var _v15 = n - 1,_v16 = _p19._1;
                     n = _v15;
                     l = _v16;
                     continue nth;
                  }
   ...
   var formatQuestion = function (q) {
      var s = function () {
         var _p20 = q;
         switch (_p20.ctor)
         {case "Hobby": return A2($Basics._op["++"],"Who likes ",A2($Basics._op["++"],$String.toLower(_p20._0),"?"));
            case "Food": return A2($Basics._op["++"],"Who likes ",A2($Basics._op["++"],$String.toLower(_p20._0),"?"));
            default: return A2($Basics._op["++"],"Who dislikes ",A2($Basics._op["++"],$String.toLower(_p20._0),"?"));}
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"question text-",btnColor))]),_U.list([$Html.text(s)]));
   };
   var view = F2(function (address,model) {
      var str = function () {
         var _p21 = model.question;
         switch (_p21.ctor)
         {case "Debug": return $Html.text(_p21._0);
            case "End": return A2(resultView,address,model);
            case "Pending": var _p23 = _p21._2;
              var fquestion = formatQuestion(_p23);
              var fprogress = formatProgress(model.score);
              var _p22 = model.idols;
              if (_p22.ctor === "Just") {
                    return A2($Html.div,
                    _U.list([]),
                    A2($Basics._op["++"],_U.list([fquestion]),A2($Basics._op["++"],A4(idolOptions,address,_p23,_p21._0,_p21._1),_U.list([fprogress]))));
                 } else {
