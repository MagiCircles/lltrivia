...
Elm.Question.make = function (_elm) {
         ...
         {case "IdolHobby": return $Html.text(A2($Basics._op["++"],"Who likes ",A2($Basics._op["++"],$String.toLower(_p0._0),"?")));
            ...
            case "SongPlay": var _p2 = _p0._1;
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("song-question")]),_U.list([$Html.text("What is this song?")]))]))
            ...
            case "SongCover": return A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("song-image-question-detail")
   ...
   var getSongName = function (song) {    var _p14 = song.romaji_name;if (_p14.ctor === "Just") {    return _p14._0;} else {    return song.name;}};
   ...
   var imageOptions = F3(function (address,question,images) {
      var format = function (_p15) {
         var _p16 = _p15;
         var _p17 = _p16._1;
         return A2($Html.a,
         _U.list([$Html$Attributes.href("#"),A2($Html$Events.onClick,address,Answer(A2(answerQuestion,StringAnswer(_p17),question)))]),
         _U.list([A2($Html.img,_U.list([$Html$Attributes.src(_p16._0),$Html$Attributes.alt(_p17),$Html$Attributes.$class("choice-image")]),_U.list([]))]));
      };
      ...
      var aux = F2(function (acc,l) {
         aux: while (true) {
            ...
            if (_p18.ctor === "[]") {
                  ...
                  var _v15 = A2($List._op["::"],format(_p18._0),acc),_v16 = _p18._1;
                  acc = _v15;
                  l = _v16;
                  continue aux;
               }
   ...
   var songOptions = F3(function (address,question,songs) {
      var format = function (element) {
         var name = getSongName(element);
         var _p19 = question.question;
         switch (_p19.ctor)
         {case "SongPlay": return A2($Html.figure,
              ...
              _U.list([A2($Html.img,
                      ...
                      ,A2($Html.figcaption,_U.list([]),_U.list([$Html.text(name)]))]));
            case "SongCover": return A2($Html.div,
              _U.list([$Html$Attributes.$class("trivia_song")]),
              _U.list([A2($Html.span,
              _U.list([A2($Html$Events.onClick,address,Answer(A2(answerQuestion,SongAnswer(element),question)))]),
              _U.list([$Html.text(name)]))]));
      ...
      var aux = F2(function (acc,l) {
         aux: while (true) {
            ...
            if (_p20.ctor === "[]") {
                  ...
                  var _v19 = A2($List._op["::"],format(_p20._0),acc),_v20 = _p20._1;
                  acc = _v19;
                  l = _v20;
                  continue aux;
               }
   ...
   var optionsToHtml = F2(function (address,question) {
      var _p21 = question.question;
      switch (_p21.ctor)
      {case "IdolHobby": return A3(idolOptions,address,question,_p21._2);
         case "IdolFood": return A3(idolOptions,address,question,_p21._2);
         case "IdolLeastFood": return A3(idolOptions,address,question,_p21._2);
         case "SongCover": return A3(songOptions,address,question,_p21._2);
         case "SongPlay": return A3(songOptions,address,question,_p21._3);
         case "CardRarity": return A3(imageOptions,
           address,
           question,
           _U.list([{ctor: "_Tuple2",_0: A2($Basics._op["++"],"https://i.schoolido.lu/static/N",A2($Basics._op["++"],btnColor,".png")),_1: "N"}
                   ,{ctor: "_Tuple2",_0: A2($Basics._op["++"],"https://i.schoolido.lu/static/R",A2($Basics._op["++"],btnColor,".png")),_1: "R"}
                   ,{ctor: "_Tuple2",_0: A2($Basics._op["++"],"https://i.schoolido.lu/static/SR",A2($Basics._op["++"],btnColor,".png")),_1: "SR"}
                   ,{ctor: "_Tuple2",_0: A2($Basics._op["++"],"https://i.schoolido.lu/static/SSR",A2($Basics._op["++"],btnColor,".png")),_1: "SSR"}
                   ,{ctor: "_Tuple2",_0: A2($Basics._op["++"],"https://i.schoolido.lu/static/UR",A2($Basics._op["++"],btnColor,".png")),_1: "UR"}]));
         case "CardAttribute": return A3(imageOptions,
           address,
           question,
           _U.list([{ctor: "_Tuple2",_0: "https://i.schoolido.lu/static/Smile.png",_1: "Smile"}
                   ,{ctor: "_Tuple2",_0: "https://i.schoolido.lu/static/Pure.png",_1: "Pure"}
                   ,{ctor: "_Tuple2",_0: "https://i.schoolido.lu/static/Cool.png",_1: "Cool"}
                   ,{ctor: "_Tuple2",_0: "https://i.schoolido.lu/static/All.png",_1: "All"}]));
         default: return A3(idolOptions,address,question,_p21._2);}
   });
...
Elm.Main.make = function (_elm) {
   ...
   var formatQuizzButtons = F2(function (addr,quizz) {
      ...
      _U.list([A2($Html.li,
              ...
              _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("flaticon-song")]),_U.list([])),$Html.text(" Songs")]))]))
              ,A2($Html.li,
              function () {
                 var _p3 = quizz;
                 if (_p3.ctor === "Idols") {
                      ...
                      _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("score_comment")]),_U.list([$Html.text(comment)]))
                              ...
                              _U.list([A2($Html.a,
                                      _U.list([$Html$Attributes.href(A2($Basics._op["++"],
                                              ...
                                              A2($Basics._op["++"],
                                              comment,
                                              " Play with me:&via=schoolidolu&url=https://schoolido.lu/trivia/&hashtags=LLSIF,LoveLive,スクフェス")))))
   ...
   var idolDecoder = function () {
      var idol = $Json$Decode.maybe(A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
   ...
   var cardsDecoder = function () {
      ...
      var card = $Json$Decode.maybe(A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
      A2(_op["**"],
