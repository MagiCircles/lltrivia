...
Elm.Main.make = function (_elm) {
   ...
   var formatQuestion = function (q) {
      var s = function () {
         var _p0 = q;
         switch (_p0.ctor)
         {case "Hobby": return A2($Basics._op["++"],
              "Who likes ",
              A2($Basics._op["++"],_p0._0,"?"));
            case "Food": return A2($Basics._op["++"],
              "Who likes ",
              A2($Basics._op["++"],_p0._0,"?"));
   ...
   var Model = F4(function (a,b,c,d) {
      return {idols: a,question: b,seed: c,score: d};
   });
   ...
   var idolOptions = F4(function (address,question,idol,idols) {
      var format = function (element) {
         ...
         _U.list([$Html$Attributes.src(element.chibi)
                 ,A2($Html$Events.onClick,address,A2(Answer,question,element))]),
      ...
      var aux = F2(function (acc,l) {
         aux: while (true) {
            ...
            if (_p2.ctor === "[]") {
                  ...
                  var _v3 = A2($List._op["::"],format(_p2._0),acc),
                  _v4 = _p2._1;
                  acc = _v3;
                  l = _v4;
                  continue aux;
   ...
   var resultView = F2(function (addr,model) {
      ...
      _U.list([$Html.text(A2($Basics._op["++"],
              ...
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,addr,Restart)]),
   ...
   var view = F2(function (address,model) {
      var str = function () {
         ...
         switch (_p3.ctor)
         {case "Debug": return $Html.text(_p3._0);
            case "End": return A2(resultView,address,model);
            default: var _p5 = _p3._2;
              var fquestion = formatQuestion(_p5);
              var _p4 = model.idols;
              if (_p4.ctor === "Just") {
                    return A2($Html.div,
                    _U.list([]),
                    A2($Basics._op["++"],
                    _U.list([fquestion]),
                    A4(idolOptions,address,_p5,_p3._0,_p3._1)));
                 } else {
                    return $Html.text("lol");
                 }}
      }();
      return A2($Html.div,
   ...
   var End = {ctor: "End"};
   var Pending = F3(function (a,b,c) {
      return {ctor: "Pending",_0: a,_1: b,_2: c};
   });
   var Hobby = function (a) {    return {ctor: "Hobby",_0: a};};
   var LeastFood = function (a) {
      return {ctor: "LeastFood",_0: a};
   };
   ...
   var getRandomIdol = function (str) {
      return $Effects.task(A2($Task.map,
      GotIdols,
      $Task.toMaybe(A2($Http.get,idolDecoder,url))));
   };
   var nth = F2(function (n,l) {
      nth: while (true) {
         ...
         if (_p6.ctor === "[]") {
               ...
               if (_U.cmp(n,0) < 1) return $Maybe.Just(_p6._0); else {
                     var _v8 = n - 1,_v9 = _p6._1;
                     n = _v8;
                     l = _v9;
                     continue nth;
                  }
   ...
   var randomInt = F2(function (upper,seed) {
      return A2($Random.generate,A2($Random.$int,0,upper),seed);
   });
   var takeRandom = F2(function (l,seed) {
      var len = $List.length(l) - 1;
      var _p7 = A2(randomInt,len,seed);
      var qid = _p7._0;
      var s = _p7._1;
      var _p8 = A2(nth,qid,l);
      if (_p8.ctor === "Just") {
            return $Maybe.Just({ctor: "_Tuple2",_0: _p8._0,_1: s});
         } else {
            return $Maybe.Nothing;
         }
   });
   var randomChoices = F4(function (idol,num,idols,seed) {
      var aux = F4(function (idolss,n,acc,seed) {
         aux: while (true) if (_U.eq(n,0)) return {ctor: "_Tuple2"
                                                  ,_0: acc
                                                  ,_1: seed}; else {
               var _p9 = A2(takeRandom,idolss,seed);
               if (_p9.ctor === "Nothing") {
                     return {ctor: "_Tuple2",_0: acc,_1: seed};
                  } else {
                     var _p10 = _p9._0._0;
                     var _v12 = A2($List.filter,
                     F2(function (x,y) {    return !_U.eq(x,y);})(_p10),
                     idolss),
                     _v13 = n - 1,
                     _v14 = A2($List._op["::"],_p10,acc),
                     _v15 = _p9._0._1;
                     idolss = _v12;
                     n = _v13;
                     acc = _v14;
      ...
      return A4(aux,
      A2($List.filter,
      F2(function (x,y) {    return !_U.eq(x,y);})(idol),
      idols),
      num,
      _U.list([idol]),
      seed);
   ...
   var shuffleList = F2(function (idols,seed) {
      ...
      if (_p11.ctor === "[]") {
            ...
            if (_p11._1.ctor === "[]") {
                  ...
                  return A4(randomChoices,_p11._0,len - 1,idols,seed);
               }
         }
   });
   ...
   var pickQuestion = F2(function (idols,seed) {
      ...
      if (_p12.ctor === "Just") {
            var _p19 = _p12._0;
            var _p13 = A2(pickIdol,_p19,seed);
            if (_p13.ctor === "Just") {
                  var _p18 = _p13._0._1;
                  var _p17 = _p13._0._0;
                  ...
                  A3(mapQuestion,
                  LeastFood,
                  _p17.least_favorite_food,
                  A3(mapQuestion,Food,_p17.favorite_food,_U.list([]))));
                  var _p14 = A2(takeRandom,questions,_p18);
                  if (_p14.ctor === "Just") {
                        var _p15 = A4(randomChoices,_p17,3,_p19,_p14._0._1);
                        var choices = _p15._0;
                        var seed = _p15._1;
                        var _p16 = A2(shuffleList,choices,seed);
                        var shuffled = _p16._0;
                        var seed = _p16._1;
                        return {ctor: "_Tuple2"
                               ,_0: A3(Pending,_p17,shuffled,_p14._0._0)
                               ,_1: seed};
                     } else {
                        return {ctor: "_Tuple2"
            ...
            return {ctor: "_Tuple2"
                   ,_0: Debug("Error while fetching idols")
                   ,_1: seed};
         }
   });
   var update = F2(function (action,model) {
      var _p20 = action;
      switch (_p20.ctor)
      {case "Restart": var _p21 = A2(pickQuestion,
           model.idols,
           model.seed);
           var question = _p21._0;
           var seed = _p21._1;
           return {ctor: "_Tuple2"
                  ,_0: {question: question
                       ,seed: seed
                       ,score: _U.list([])
                       ,idols: model.idols}
                  ,_1: $Effects.none};
         case "Answer": var _p22 = model.question;
           if (_p22.ctor === "Pending") {
                 var score = !_U.eq(_p22._0.name,_p20._1.name) ? false : true;
                 var _p23 = !_U.eq($List.length(model.score),
                 10) ? A2(pickQuestion,model.idols,model.seed) : {ctor: "_Tuple2"
                                                                 ,_0: End
                                                                 ,_1: model.seed};
                 var question = _p23._0;
                 var seed = _p23._1;
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {question: question
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{question: Debug("Error")})
                        ,_1: $Effects.none};
              }
         default: var _p25 = _p20._0;
           var _p24 = A2(pickQuestion,_p25,model.seed);
           var question = _p24._0;
           var seed = _p24._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {question: question,seed: seed,idols: _p25})
                  ,_1: $Effects.none};}
   });
